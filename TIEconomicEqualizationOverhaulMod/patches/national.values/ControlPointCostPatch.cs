...
//                float vanillaResult = (float)(Math.Pow(__instance.GDP / 1_000_000_000d, (double)TemplateManager.global.controlPointCostScaling) / (double)(TemplateManager.global.controlPointMaintenanceDivisor * (float)__instance.numControlPoints));
