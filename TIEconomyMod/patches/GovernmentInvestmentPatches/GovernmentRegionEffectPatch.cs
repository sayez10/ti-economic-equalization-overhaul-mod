...
namespace TIEconomyMod
{
    ...
    internal static class GovernmentRegionEffectPatch
    {
        ...
        internal static int legitimizeThreshold;

        // This basically is a reference to the final threshold variables, which the post-transpiler code can call on
        internal static readonly FieldInfo getLegitimizeThreshold = AccessTools.Field(typeof(GovernmentRegionEffectPatch), nameof(legitimizeThreshold));
