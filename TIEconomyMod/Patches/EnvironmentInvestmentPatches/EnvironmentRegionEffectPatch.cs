...
namespace TIEconomyMod
{
    ...
    internal static class EnvironmentRegionEffectPatch
    {
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                if (instruction.opcode == OpCodes.Ldc_I4 && (int)instruction.operand == Tools.VANILLA_CLEANUP_THRESHOLD)
                {
        ...
        internal static void Recalculate()
        {
            ...
            cleanupThreshold = (Main.enabled) ? Tools.VANILLA_CLEANUP_THRESHOLD * Tools.REGION_UPGRADE_THRESHOLD_MULT : Tools.VANILLA_CLEANUP_THRESHOLD;
        }
    }
}
